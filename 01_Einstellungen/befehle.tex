...
\newcommand{\vornameStudZwei}{Oliver-Luca}
...
\newcommand{\betreuerDrei}{Dipl.-Ing.~Holger~Kuhlemann}
...
% === ABSTÄNDE ===
% HINWEIS: Diese Befehle werden aktuell NICHT verwendet.
% Die Abstände werden in der KOMA-Klasse oder in 'praeambel.tex' gesetzt.
\newcommand{\zeilenabstand}{1.15}% 1.0 für einfach, 1.15 für etwas luftiger, 1.5 für 1,5-fachen Abstand
\newcommand{\absatzabstand}{0.5em} % Abstand zwischen Absätzen (in praeambel.tex gesetzt)
\newcommand{\absatzeinzug}{0em}% Einzug der ersten Zeile (in praeambel.tex gesetzt)



% Definition für die vertikale Linie in der Kopfzeile
\newcommand{\vlinie}{\vrule width 0.5pt height 10pt depth 2pt}

% --- Leerseiten (ohne Kopf-/Fußzeile) ---
% Verwendung: \leereSeite
\newcommand{\leereSeite}{%
    \clearpage           % Beendet die aktuelle Seite
    \thispagestyle{empty} % Entfernt Kopf- und Fußzeilen für diese Seite
    \hbox{}              % Fügt ein unsichtbares Element ein, damit die Seite nicht leer ist
    \clearpage           % Beendet die leere Seite und springt zur nächsten
}
