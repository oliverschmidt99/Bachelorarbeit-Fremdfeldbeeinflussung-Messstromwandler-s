...
\usepackage[export]{adjustbox} % WICHTIG: 'export' für valign=c
...
\usepackage{etoolbox}
\usepackage[colorlinks=true, linkcolor=blue, citecolor=green, urlcolor=magenta, hidelinks]{hyperref} % Besser als letztes laden
\usepackage{eurosym}
...
% --- EINSTELLUNG FÜR KOMA-SKRIPT (entfernt Punkte im InIV) ---
...
% Definition von \subsubsubsection
\makeatletter
...
% Sorgt dafür, dass die vierte Ebene nummeriert wird (secnumdepth)
% und im Inhaltsverzeichnis erscheint (tocdepth)
