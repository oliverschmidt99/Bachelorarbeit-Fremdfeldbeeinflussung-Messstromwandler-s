...
Für die statistische Auswertung werden pro Laststufe exakt 560 Messpunkte herangezogen, was einem Zeitfenster von 4 Minuten und 40 Sekunden entspricht. Obwohl jedes Belastungsplateau steuerungstechnisch fünf Minuten gehalten wird, werden die finalen 20 Sekunden des Datensatzes verworfen. Diese Maßnahme dient als Sicherheitsmarge, um sicherzustellen, dass keine Signalflanken des nachfolgenden Schaltvorgangs in die Berechnung einfließen. Die verbleibenden 560 Werte bilden eine statistisch valide Basis für die Ergebnisermittlung. Die selektierten Intervalle werden als bereinigte Datensätze in der Datenbank für die nachfolgenden Analyseschritte persistiert.

\paragraph{Mathematische Berechnungsgrundlagen}

Die mathematische Grundlage für die in der Software ermittelten Kennwerte bildet die Berechnung der prozentualen Messabweichung \gls{sym:epsilon} gemäß Abschnitt \ref{sec:messabweichung_fehlerfortpflanzung}. Für die automatisierte Auswertung werden zunächst die arithmetischen Mittelwerte der Ströme über das stationäre Zeitfenster gebildet und anschließend miteinander verrechnet:

\begin{equation}
    \label{eq:messabweichung_allg}
    \varepsilon = \frac{\bar{I}_{\text{sec}} - \bar{I}_{\text{pri}}}{\bar{I}_{\text{pri}}} \cdot 100\,\%
\end{equation}

Hierbei beschreibt $\bar{I}_{\text{sec}}$ den arithmetischen Mittelwert der gemessenen Stromstärke des Prüflings und $\bar{I}_{\text{pri}}$ den Mittelwert des Referenzmessgerätes im identischen Zeitraum. Ergänzend hierzu berechnet die Software die Standardabweichung \gls{sym:sigma} auf Basis der Einzelmesswerte $x_i$, um das Signalrauschen innerhalb des Plateaus zu quantifizieren:
...
Diese statistische Kenngröße fungiert als Indikator für die Güte der Stromregelung sowie für die Stabilität des Messsignals.

\paragraph{Analyse und Visualisierung der Ergebnisse}

Nach Abschluss der Berechnungen stehen die Ergebnisse in zwei spezialisierten Analysemodulen zur Verfügung:

\begin{itemize}
    \item \textbf{Modul „Gesamtgenauigkeit“:} Dieses Werkzeug ermöglicht den detaillierten technischen Vergleich der Wandlercharakteristiken. Hier wird die prozentuale Messabweichung über dem Primärstrom aufgetragen. Die Darstellung ist modular konfigurierbar, sodass verschiedene Wandlertechnologien oder Messreihen unmittelbar überlagert und visuell mit den normativen Fehlergrenzen (z.\,B. Klasse 1,0) abgeglichen werden können.
    
    \item \textbf{Modul „Ökonomische Analyse“:} Um die Komplexität der Kennlinien für einen direkten Vergleich zu reduzieren, aggregiert die Software die Messabweichungen in drei signifikante Betriebsbereiche:
    \begin{itemize}
        \item \textit{Niederstrombereich:} Bewertung des Anlaufverhaltens bei geringer Last (5\,\% und 20\,\% \gls{sym:In}).
        \item \textit{Nennstrombereich:} Abbildung des Hauptarbeitsbereichs (50\,\% bis 100\,\% \gls{sym:In}).
        \item \textit{Überstrombereich:} Visualisierung des Verhaltens bei Überlast (120\,\% \gls{sym:In}).
    \end{itemize}
\end{itemize}

Um für diese Bereiche einen vergleichbaren Gütefaktor zu erhalten, wird der arithmetische Mittelwert der Absolutbeträge der Messabweichungen gebildet. Dies verhindert, dass sich positive und negative Abweichungen (z.\,B. $+0,50\,\%$ und $-0,50\,\%$) gegenseitig kompensieren, und repräsentiert die durchschnittliche Betragsabweichung des Wandlers im jeweiligen Arbeitsbereich:
...
In dieser Ansicht werden zudem konstruktive und wirtschaftliche Parameter, wie das Gehäusevolumen und die Beschaffungskosten, den aggregierten Genauigkeitswerten gegenübergestellt. Diese multidimensionale Betrachtung ermöglicht eine fundierte Bewertung der Prüflinge hinsichtlich ihres Preis-Leistungs-Verhältnisses und unterstützt die Auswahl des optimalen Stromwandlers für den spezifischen Anwendungsfall.
...
\begin{table}[H]
    ...
    \begin{tabular}{@{}lll S[table-format=4.0] S[table-format=2.1] S[table-format=4.2] S[table-format=3.2]@{}}
        \toprule
        \textbf{Hersteller} & \textbf{Typ} & \textbf{Technologie} & {\textbf{\gls{sym:In} [\unit{A}]}} & {\textbf{\gls{sym:Sn} [\unit{VA}]}} & {\textbf{Volumen [\unit{cm^3}]}} & {\textbf{Preis [\unit{\euro}]}} \\
        \midrule
        Celsa & ALO 10030     & Standard    & 2000 & 2,5 & 634,30  & 45,50  \\
        Celsa & ALO 8030 K    & Kompensiert & 2000 & 10  & 710,20  & 95,95  \\
        Celsa & ALO 10030     & Standard    & 2500 & 2,5 & 634,30  & 45,50  \\
        Celsa & ALO 10050 K   & Kompensiert & 2500 & 5   & 1027,00 & 104,20 \\
        Celsa & ALO 12070     & Standard    & 3000 & 15  & 1520,00 & 71,51  \\
        Celsa & ALO 12070 K   & Kompensiert & 3000 & 15  & 1520,00 & 346,06 \\
        Celsa & ALO 12070     & Standard    & 4000 & 15  & 1520,00 & 71,51  \\
        Celsa & ALO 12070 K   & Kompensiert & 4000 & 15  & 1520,00 & 401,91 \\
        Celsa & ALO 20060     & Standard    & 5000 & 40  & 1989,00 & 124,76 \\
        Celsa & ALO E 16050 K & Kompensiert & 5000 & 40  & 1903,00 & 414,56 \\
        \addlinespace
        MBS   & ASK 101.4     & Standard    & 2000 & 10  & 733,20  & 43,67  \\
        MBS   & ASK 129.10    & Standard    & 5000 & 15  & 6175,00 & 289,80 \\
        \addlinespace
        Redur & 13A1030.3ffp  & \gls{ffp}   & 2000 & 10  & 778,70  & 146,01 \\
        Redur & 20A1456.5FFP  & \gls{ffp}   & 5000 & 15  & 1600,00 & 296,64 \\
        \bottomrule
    \end{tabular}
\end{table}
...
Als Referenz fungiert die Parallelanordnung der drei Phasenleiter in einer Ebene. Dieser in Abbildung~\ref{pic:kupferschienen_parallel} gezeigte Aufbau bildet die realen Bedingungen in \textit{Siemens SIVACON S8} Schaltfeldern nach. Die verwendeten Abstände entsprechen den in Tabelle~\ref{tab:schienen_konfiguration} aufgeführten Herstellervorgaben. In dieser Konfiguration ist der Prüfling – hier beispielhaft der Messstromwandler \textit{Redur 20A1456.5FFP} (\SI{5000}{A}) – den maximalen magnetischen Fremdfeldern der benachbarten Leiter ausgesetzt.
...
Ziel dieser Anordnung ist eine symmetrischere Gestaltung der magnetischen Kopplung sowie die partielle Kompensation der vektoriellen Anteile der Fremdfelder im Bereich des Wandlerkerns. Auch in dieser Konfiguration wurde der \SI{5000}{A} Wandler von \textit{Redur} vermessen.
