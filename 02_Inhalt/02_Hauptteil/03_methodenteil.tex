...
\begin{itemize}
    \item \textbf{\gls{sym:Niederstrombereich}:} Erfasst das Anlaufverhalten und die Genauigkeit bei geringer Last (z.\,B. \SI{5}{\percent} und \SI{20}{\percent} \gls{sym:In}).
    \item \textbf{\gls{sym:Nennstrombereich}:} Bildet den Hauptarbeitsbereich um den Nennstrom ab (z.\,B. \SI{50}{\percent} bis \SI{100}{\percent} \gls{sym:In}).
    \item \textbf{\gls{sym:Ueberstrombereich}:} Visualisiert das Verhalten bei Überlast (z.\,B. \SI{120}{\percent} \gls{sym:In}).
\end{itemize}
...
\begin{table}[H]
    ...
    \begin{tabular}{@{}lll S[table-format=4.0] S[table-format=2.1] S[table-format=4.2] S[table-format=3.2]@{}}
        ...
        Celsa & ALO 20060     & Standard    & 5000 & 40,0 & 1989,00 & 124,76 \\
        MBS   & ASK 129.10    & Standard    & 5000 & 15,0 & 6175,00 & 289,80 \\
        \addlinespace
        ...
        Celsa & ALO E 16050 K & Kompensiert & 5000 & 40,0 & 1903,00 & 414,56 \\
        \addlinespace
        Redur & 13A1030.3ffp  & \glsentryshort{ffp}   & 2000 & 10,0 & 778,70  & 146,01 \\
        Redur & 20A1456.5FFP  & \glsentryshort{ffp}   & 5000 & 15,0 & 1600,00 & 296,64 \\
        \bottomrule
    \end{tabular}
\end{table}
