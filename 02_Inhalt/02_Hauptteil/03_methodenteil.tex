...
\begin{aufgabenbox}
Die Grenzen müssen auf 0,2 gestellt werden, da es eine MEssung für die Klasse 0,2 ist.    

\einfuegenBildGross{03_Ressourcen/diagramme/dia_messstrecke_alt.pdf}{Analyse der Messabweichung und Standardabweichung der Phasen L1, L2 und L3 im ursprünglichen Versuchsaufbau}{pic:dia_messstrecke_alt}
...
\einfuegenBildGross{03_Ressourcen/diagramme/dia_messstrecke_neu.pdf}{Vergleichende Analyse der Messabweichung (oben) und Standardabweichung (unten) unter Einsatz des PAC 4220}{pic:dia_messstrecke_neu}
