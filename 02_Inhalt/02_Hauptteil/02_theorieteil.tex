...
Das grundlegende Funktionsprinzip basiert auf der galvanischen Trennung zwischen dem Primär- und dem Sekundärkreis. Der Wandler erzeugt einen sekundären Ausgangsstrom, der im Idealfall sowohl in der Amplitude proportional als auch in der Phasenlage gleich zum primären Eingangsstrom ist. Dies ermöglicht den Anschluss von standardisierten Messgeräten, Zählern oder Schutzrelais, die üblicherweise für Nennströme von $1\,\text{A}$ oder $5\,\text{A}$ ausgelegt sind, ohne diese dem hohen Potenzial oder den hohen Strömen des Primärleiters auszusetzen.
