...
Im unteren untersuchten Strombereich zeigt sich ein starker Wettbewerb zwischen den Standardwandlern und den technologisch aufwendigeren Lösungen. Wie Abbildung \ref{dia:2000A_ranking_plot} für \SI{2000}{A} und Abbildung \ref{dia:2500A_ranking_plot} für \SI{2500}{A} illustrieren, bieten Standardwandler hier oft den günstigsten Einstiegspreis. Allerdings offenbart der Performance-Index, dass die vermeintlich günstigste Lösung in der Parallelanordnung aufgrund der hohen Fehleraufschläge im Ranking abrutscht. Die kompensierten Wandler positionieren sich hier als robuste Allrounder: Sie sind zwar teurer in der Anschaffung, kompensieren dies jedoch durch eine signifikant höhere Messstabilität.
...
\subsubsection{Verschiebung der Kosteneffizienz bei Hochstrom (\SI{3000}{A} bis \SI{5000}{A})}

Mit steigendem Primärstrom verändern sich die ökonomischen Vorzeichen drastisch. Ab \SI{3000}{A} (siehe Abbildung \ref{dia:3000A_ranking_plot}) beginnen einfache Standardwandler in der Parallelanordnung physikalisch zu sättigen, wodurch ihr Fehler-Score explodiert. Das führt zu dem Paradoxon, dass das billigste Bauteil ökonomisch unbrauchbar wird, da die Messdaten nicht valide sind.

In den Bereichen von \SI{4000}{A} und \SI{5000}{A} (Abbildungen \ref{dia:4000A_ranking_plot} und \ref{dia:5000A_ranking_plot}) kristallisiert sich heraus, dass eine Investition in Geometrie-Optimierung (Dreiecksanordnung) oft wirtschaftlicher ist als der Kauf teurer Spezialwandler. Besonders hervorzuheben ist bei \SI{5000}{A} der Standardwandler in Dreiecksanordnung: Er liefert Präzisionswerte, die sonst nur wesentlich teurere Wandler mit Fremdfeldprotektoren erreichen, kostet aber nur einen Bruchteil. Er ist damit der klare Gewinner im Preis-Leistungs-Ranking für Hochstromanwendungen, sofern die Verschienung eine Dreiecksanordnung zulässt.
