...
Die Messreihe bei einer Stromstärke von \SI{3000}{A} dient als detaillierte Fallstudie für das Verhalten der Wandler unter variierenden Betriebsbedingungen. Im Fokus steht der Vergleich zwischen dem Standardwandler Celsa ALO 12070 und der kompensierten Ausführung wie in Abbildung \ref{dia:3000A_zusammenfassung} dargestellt. Zusätzlich zur geometrischen Anordnung wird in diesem Lastpunkt der Einfluss des sekundären Bürdenwiderstands in der Parallelanordnung isoliert betrachtet.
...
Zur Untersuchung des Einflusses der Bürde auf die Messgenauigkeit wurden drei unterschiedliche Szenarien betrachtet welche in Tabelle \ref{tab:buerden_konfigurationen_3000A} zusammengefasst sind. Im ersten Fall werden alle Wandler mit der Nennbürde belastet. Da der Wandler ALO 12070 3000/1 eine Nennleistung von \SI{15}{VA} aufweist wurde dieser im Referenzfall mit einem Widerstand von \SI{10,8}{\ohm} beschaltet. Die nächste Konfiguration untersucht den Wandler bei direktem Anschluss an das Messgerät ohne zusätzlichen Vorwiderstand. Bei der letzten Messung wurde am mittleren Leiter L2 der Bürdenwiderstand entfernt wohingegen die Außenleiter L1 und L3 weiterhin mit \SI{10,8}{\ohm} belastet wurden.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{03_Ressourcen/dia_3000A_buerde/dia_3000A_buerde-Zusammenfassung_MultiCurrent.pdf}
    \caption{Vergleich von Geometrie und Bürdeneinfluss bei \SI{3000}{A}}
    \label{dia:3000A_zusammenfassung}
\end{figure}
