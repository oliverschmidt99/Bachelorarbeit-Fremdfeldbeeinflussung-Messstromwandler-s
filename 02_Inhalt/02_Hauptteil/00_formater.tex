    ...
    \begin{beamercolorbox}[wd=\textwidth, sep=1ex, rounded=true, shadow=true]{examplebox}
        \begin{columns}[T]
            \begin{column}{0.3\textwidth}
                ...
                \begin{figure}
                    \centering
                    \includegraphics[width=0.85\linewidth]{03_Ressourcen//erwärmungsprüfstand/6300A_Wandler_1.jpg}
                \end{figure}
            ...
            \begin{column}{0.55\textwidth}
                \begin{figure}
                    \centering
                    \includegraphics[width=0.85\linewidth]{03_Ressourcen//erwärmungsprüfstand/6300A_Wandler_2.jpg}
                \end{figure}
            \end{column}
        \end{columns}
    \end{beamercolorbox}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item \textbf{Anwendungsbereiche:}
              \begin{itemize}
                  \item Magnetostatik (wie in diesem Fall)
                  \item Magnetodynamik (Wechselfelder)
                  \item Elektrische Felder und Wärmeübertragung
              \end{itemize}
        \item \textbf{Ziel im Projekt:} Visualisierung und Quantifizierung der magnetischen Flussdichte ($B$) im Wandlerkern, die durch das Fremdfeld des Nachbarleiters induziert wird.
    \end{itemize}
    \vfill
    \begin{center}
        \textit{(Hier war der Screenshot der FEMM-Benutzeroberfläche mit dem 2D-Modell eines Wandlers auf einer Sammelschiene zu sehen.)}
    \end{center}
\end{frame}
