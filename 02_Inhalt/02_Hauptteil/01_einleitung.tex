...
Die fortschreitende Energiewende und die damit verbundene Dezentralisierung der Energieversorgung erhöhen die Anforderungen an die elektrische Energieverteilung maßgeblich \cite{VDE_Studie_Dezentralisierung}. Niederspannungsschaltanlagen fungieren hierbei als kritische Knotenpunkte innerhalb der industriellen Infrastruktur. Neben der Gewährleistung der Betriebssicherheit gewinnt die präzise Erfassung von Energieströmen stetig an Bedeutung. Diese ist sowohl für die energiewirtschaftliche Abrechnung als auch für ein modernes Energiemanagement sowie die Sicherstellung der Netzstabilität unerlässlich \cite{ISO50001}.

Hersteller wie die \textit{Rolf Janssen Elektrotechnische Werke GmbH} agieren dabei in einem Spannungsfeld aus wirtschaftlichen und konstruktiven Restriktionen. Die begrenzte räumliche Kapazität in technischen Betriebsräumen erfordert die Konzeption kompakter Schaltanlagen \cite[Kap.~1.4]{Siemens_Planungshandbuch}, woraus eine hohe Packungsdichte der verbauten Komponenten resultiert. Infolgedessen verlaufen Leiterbahnen, die Ströme im Bereich von mehreren Kiloampere führen, in unmittelbarer Nähe zu den Messstromwandlern.
...
Moderne Niederspannungsschaltanlagen müssen eine hohe Stromtragfähigkeit bei kompakter Bauweise bieten. Die daraus folgende räumliche Nähe der Leiter und die hohen Betriebsströme setzen Messstromwandler magnetischen Fremdfeldern aus \cite{Redur2021Fremdfeld}. Dieser Effekt ist in Drehstromsystemen relevant, da die Leiter der Phasen L1, L2 und L3 üblicherweise parallel angeordnet sind. Die magnetischen Wechselfelder der benachbarten Leiter beeinflussen hierdurch die Messstellen der anderen Phasen.
