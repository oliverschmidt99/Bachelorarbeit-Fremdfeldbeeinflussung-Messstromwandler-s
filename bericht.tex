...
Die Validierung der optimierten Messstrecke belegt eine Steigerung der Messgüte im Vergleich zu den ursprünglichen Komponenten. Das folgende Diagramm zeigt den Fehlerverlauf des neu installierten Energiemessgerätes PAC 4220 im direkten Vergleich zum Messumformer K3 und den Rogowskispulen.
...
Die im unteren Teil der Abbildung visualisierte Standardabweichung dient als Maß für die Präzision und Reproduzierbarkeit der Messsysteme. Das PAC 4220 und der Messumformer K3 weisen ein ähnliches Verhalten mit einer geringen Streuung auf. Die Rogowskispulen zeigen hingegen über den gesamten Messbereich eine höhere Streuung.
